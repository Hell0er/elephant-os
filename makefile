...
$(BUILD_DIR)/main.o: kernel/main.c lib/kernel/print.h \
	...
	lib/kernel/stdio-kernel.o fs/fs.o lib/string.h fs/file.h \
	shell/shell.o kernel/debug.h userprog/exec.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/timer.o: device/timer.c device/timer.h lib/kernel/io.h \
	lib/kernel/print.h kernel/interrupt.h thread/thread.h kernel/debug.h 
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/thread.o: thread/thread.c thread/thread.h \
	...
	kernel/debug.h kernel/interrupt.h lib/kernel/print.h userprog/process.h \
	lib/stdio.h fs/file.h fs/fs.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/syscall.o: lib/user/syscall.c lib/user/syscall.h \
	lib/stdint.h fs/fs.h thread/thread.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/syscall-init.o: userprog/syscall-init.c userprog/syscall-init.h \
	lib/user/syscall.h lib/stdint.h lib/kernel/print.h device/console.h \
	thread/thread.h lib/string.h kernel/memory.h fs/fs.h userprog/fork.h \
	userprog/exec.h userprog/wait_exit.h shell/pipe.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/fs.o: fs/fs.c fs/fs.h fs/super_block.h fs/inode.h fs/dir.h \
	...
	device/ide.h kernel/global.h kernel/debug.h kernel/memory.h \
...
$(BUILD_DIR)/fork.o: userprog/fork.c userprog/fork.h thread/thread.h \
	userprog/process.h kernel/memory.h kernel/interrupt.h kernel/debug.h \
	lib/string.h fs/file.h 
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/shell.o: shell/shell.c shell/shell.h lib/stdint.h fs/fs.h \
	lib/user/syscall.h lib/stdio.h lib/stdint.h kernel/global.h \
	kernel/debug.h fs/fs.h shell/buildin_cmd.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/buildin_cmd.o: shell/buildin_cmd.c shell/buildin_cmd.h lib/stdint.h \
	lib/user/syscall.h lib/stdio.h lib/string.h kernel/global.h \
	kernel/debug.h fs/fs.h fs/dir.h shell/shell.h 
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/exec.o: userprog/exec.c userprog/exec.h lib/stdint.h \
	thread/thread.h lib/kernel/stdio-kernel.h fs/fs.h lib/string.h \
	kernel/global.h kernel/memory.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/wait_exit.o: userprog/wait_exit.c userprog/wait_exit.h \
	thread/thread.h lib/stdint.h lib/kernel/list.h kernel/global.h \
	lib/kernel/bitmap.h kernel/memory.h kernel/debug.h \
	lib/kernel/stdio-kernel.h fs/fs.h fs/file.h shell/pipe.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/pipe.o: shell/pipe.c shell/pipe.h lib/stdint.h kernel/global.h \
	kernel/memory.h fs/fs.h fs/file.h device/ioqueue.h thread/thread.h
	$(CC) $(CFLAGS) $< -o $@
